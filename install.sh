...
DATABASE_URL=postgres://postgres:${POSTGRES_PASSWORD}@postgres:5432/clovalink

# Redis
REDIS_URL=redis://redis:6379

# Storage (local by default, configure S3 for production)
STORAGE_TYPE=local

# Optional: S3/Backblaze B2/Wasabi configuration
